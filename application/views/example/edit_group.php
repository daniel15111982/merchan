	...
	<?php
		...
		if( ! empty($group))
		{
			echo '<tr>
					...
					<td>'.form_input('name', set_value('name', $group->name)).'</td>
				  </tr>';
			echo '<tr>
					<td class="label">Description</td>
				    <td>'.form_textarea('description', set_value('description', $group->description)).'</td>
				  </tr>';
			echo '<tr>
					<td class="label">Roles</td>
					<td>'.form_multiselect('roles[]', $roles, set_value('roles[]', $group_roles)).'</td>
				  </tr>';
			echo '<tr>
					<td class="label">Members</td>
					<td>'.form_multiselect('members[]', $users, set_value('members[]', $group->members)).'</td>
				  </tr>';
